...
--
-- Host: localhost
-- Generation Time: Dec 02, 2011 at 01:26 PM
...
CREATE TABLE IF NOT EXISTS `sources` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(180) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
...
--
-- Table structure for table `sources_event`
--

CREATE TABLE IF NOT EXISTS `sources_event` (
...
--
-- Dumping data for table `sources_event`
--
...
--
-- Table structure for table `sources_organization`
--

CREATE TABLE IF NOT EXISTS `sources_organization` (
  `source_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `sources_organization`
--
...
--
-- Table structure for table `sources_person`
--

CREATE TABLE IF NOT EXISTS `sources_person` (
  `source_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `sources_person`
--
...
--
-- Table structure for table `sources_project`
--

CREATE TABLE IF NOT EXISTS `sources_project` (
  `source_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `sources_project`
--
