...
function print_country(country_id){
	...
	for(x in country_arr){
		option_str.append("<option value='"+country_arr[x]+"'>"+country_arr[x]+"</option>");
	}
}
...
function print_state(state_id, state_index){
    ...
    option_str.html("");
    option_str.append("<option value='' class='message'>State</option>");
	for(x in state_arr){
        option_str.append("<option value='"+state_arr[x]+"'>"+state_arr[x]+"</option>");
	}
}
