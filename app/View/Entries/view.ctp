...
<section class="tagLists">
    <div class='' style='display:none;'>
        <ul>
            ...
            <li class='<?php echo $t['category']; ?>'><input type='checkbox'
                                                             data-filter='.<?php echo str_replace(' ', '-', $t['name']); ?>'/><?php echo $t['name']; ?>
            </li>
            <?php endforeach; ?>
        </ul>
    </div>
...
<section class="mosaicBody">
    <ul class="mosaicContainer loading cf">
        <li class="dynamic <?php echo $entry['Category']['category']; ?>">
            <p><?php echo limit_words($entry['Entry']['description'], 120); ?></p></li>
        ...
        <li class="tile connection <?php echo $c['Entry']['Category']['category']; echo " " . implode(' ', str_replace(' ', '-', $c['tags'])); ?>">
            ...
            <div class='bottom-link'>
                ...
                <a class='link-button' href='/entries/view/<?php echo $c['Entry']['slug']; ?>'><span
                ...
                <li class="tile story story-video">
                    <div class='container'>
                        <!--
                          4:3 aspect ratio
                        -->
                        <div class='lite' style='width:478px; height:359px'
                             id="<?php echo $s['Story']['video']; ?>"></div>
                    </div>
                    <div class='bottom-link'>
                    <span id='opener'
                          data-title='<?php echo $s['Story']['title']; ?>'
                    ...
                    <span><?php if ($can_like): echo $this->Like->like('Entry', $s['Story']['id']);?> &nbsp; <?php endif; ?>
                        <?php echo $this->Like->dislike('Entry', $s['Story']['id']); ?>
                    </span>
