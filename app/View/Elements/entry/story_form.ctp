...
<ul class="story-fields all-fields">
    ...
    <li class="story-source fields"><input type="checkbox" id="story-source" name="source" value="yes" /><label for="story-source">I got this description from somewhere else</label></li>
